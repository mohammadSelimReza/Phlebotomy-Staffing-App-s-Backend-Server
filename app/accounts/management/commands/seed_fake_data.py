# app/management/commands/seed_fake_data.py
...
from app.accounts.models import CustomerUser, AppointmentModel, ReportUserModel
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # ============================================================
        # 9. CREATE INAPPROPRIATE MESSAGE REPORTS
        # ============================================================
